/**
 * @extends-from components/home/classroom-card.tsx
...
import { Atom, Copy, Pencil, SquarePen, Trash2 } from 'lucide-react';
          ...
          {!confirmingDelete && (
            ...
            >
              ...
              <Button
                size="icon"
                variant="ghost"
                className="absolute top-2 right-20 size-7 opacity-0 group-hover:opacity-100 transition-opacity bg-black/30 hover:bg-violet-600/85 text-white hover:text-white backdrop-blur-sm rounded-full"
                onClick={(e) => {
                  e.stopPropagation();
                  router.push(buildCourseEditPath(classroom.id));
                }}
                title={t('courseEditor.editCourse')}
                aria-label={t('courseEditor.editCourse')}
              >
