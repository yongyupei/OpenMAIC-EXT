/**
 * @extends-from components/settings/index.tsx
...
import { createCustomProviderSettings, getProviderTypeLabel } from '@/components/settings/utils';
...
import { ModelEditDialog } from '@/components/settings/model-edit-dialog';
import { AddProviderDialog, type NewProviderData } from '@/components/settings/add-provider-dialog';
import { AddAudioProviderDialog, type NewAudioProviderData } from '@/components/settings/add-audio-provider-dialog';
