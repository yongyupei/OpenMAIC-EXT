...
export { buildPromptWithOverrides } from './build-with-overrides';
export {
  GENERATION_PROMPT_ALLOWLIST,
  isAllowedGenerationPromptId,
  sanitizePromptOverrides,
} from './generation-prompt-allowlist';
...
export const PROMPT_IDS = {
  ...
  HTML_SLIDE_CONTENT: 'html-slide-content',
  QUIZ_CONTENT: 'quiz-content',
  SLIDE_ACTIONS: 'slide-actions',
  HTML_SLIDE_ACTIONS: 'html-slide-actions',
  ...
  KNOWLEDGE_BASE_PLAN: 'knowledge-base-plan',
