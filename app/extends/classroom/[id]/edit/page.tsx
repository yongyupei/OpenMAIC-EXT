/**
 * @extends-from app/classroom/[id]/edit/page.tsx
...
import { ensureGenerationSnapshotsOnLoad } from '@/lib/generation/slide-generation-snapshot';
  ...
  const loadClassroom = useCallback(async () => {
    try {
      ...
      if (loadedStage?.id !== classroomId) {
        ...
        useStageStore.getState().setScenes(ensureGenerationSnapshotsOnLoad(scenes));
